...
public final class Settings {
	...
	public static final String HELP_CC_NAME = "Avalon";
	...
	public static int SKILLING_XP_RATE = 2;
	...
	// --- UPDATE/GRAB pair (server uses PRIVATE exponent d) ---
	...
	public static final String[] DEVELOPERS = { "Wikner", "Andreas", "Manager", "Isik", "Mujtaba", "nostlgia" };
